...
(() => {
  ...
  const chart = new Chart(ctx, {
    ...
    data: {
      labels: [],
      datasets: [
        { label: 'Độ ẩm (AI)', data: [], borderColor:'#5fb371', borderDash:[6,4], yAxisID: 'yA', tension:0.3 },
        { label: 'Độ ẩm (không AI)', data: [], borderColor:'#3a7bd5', yAxisID: 'yA', tension:0.3 },
        { label: 'Năng lượng (AI)', data: [], borderColor:'#f7a26d', borderDash:[6,4], yAxisID: 'yB', tension:0.3 },
        { label: 'Năng lượng (không AI)', data: [], borderColor:'#d68910', yAxisID: 'yB', tension:0.3 }
      ]
    },
    options: {
      animation: false,
      scales: {
        yA: { type:'linear', position:'left', min:0, max:100, title:{display:true,text:'Độ ẩm (%)'} },
        yB: { type:'linear', position:'right', title:{display:true,text:'Năng lượng (Wh)'} }
      },
